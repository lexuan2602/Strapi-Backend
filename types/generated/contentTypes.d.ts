...
export interface ApiHeartRadioHeartRadio extends Schema.CollectionType {
  ...
  attributes: {
    RadioName: Attribute.String;
    RadioDescription: Attribute.Text;
    YoutubeVideo: Attribute.Component<'playlist-youtube.playlist', true>;
    Category: Attribute.Relation<
      'api::heart-radio.heart-radio',
      'oneToOne',
      'api::category.category'
    >;
    RadioThumbnail: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
